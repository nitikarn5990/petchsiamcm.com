                                            ...
                                            <ul>
                                                <?php while ($row = $db->FetchArray($query)) { ?>
                                                    <li> 
                                                        ...
                                                        </span> <span class="label" style="background-color: #e15656;"><a style="color:#FFF !important;" href="<?php echo ADDRESS_GALLERY . $row['file_name'] ?>" target="_blank"> <img src="../files/gallery/<?= $row['file_name'] ?>" style="max-width: 200px;"></a> <a href="<?php echo ADDRESS_ADMIN_CONTROL ?>product&action=edit&id=<?php echo $_GET['id'] ?>&product_files_id=<?php echo $row['id'] ?>" style="color:#FFF; font-size:12px; text-decoration: none;" onclick="return confirm('Are you sure you want to delete?')" > ลบไฟล์ </a></span>
                                                        <?php $k++; ?>
                                                    </li>
                                                <?php } ?>
                                            <?php } ?>
